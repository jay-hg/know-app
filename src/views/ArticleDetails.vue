  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="content-time">
        发布于 {{ data.article.createAt }} · 未经作者允许禁止转载
      </div>
    </div>
    ...
    <div class="bottom-bar">
      ...
      >
        <div style="display: flex">
          ...
          <span class="s1">投票 {{ data.article.agreeCount }}</span>
        </div>
      </van-button>
      <van-button
        round
        type="info"
        :to="'/article/gift-vote/' + this.$route.params.id"
      >
        <div style="display: flex">
          <van-icon class="bottom-bar-icon" size="20" name="play" />
    ...
    >
      <div style="padding: 15px">
        ...
        <div class="popup-content">
          <div
            style="padding-top: 10px; letter-spacing: 1px; padding-bottom: 20px"
          >
